...
public class TelaPrincipal {
	...
	public static boolean eUmNumero(String qtdDigitada, int turno)
	{
		for (int i = 0; i < qtdDigitada.length(); i++)
			if (!Character.toString(qtdDigitada.charAt(i)).equals("1") &&  !Character.toString(qtdDigitada.charAt(i)).equals("2") && !Character.toString(qtdDigitada.charAt(i)).equals("3"))
					return (false);
		return (true);
	}
